...
@section('content')
    <div class="row justify-content-center">
        <div class="col-9">
            <form method="post" action="./draw" id="deposit_send">
                {{csrf_field()}}
                ...
                <div class="card bg-light mb-3" style="max-width: 40rem;">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group" id="">
                            <label for="balance">จำนวนเงินถอน</label>
                            <div class="input-group" id="customer-number">
                ...
                success: function (data) {
                    ...
                    $("#customer-number")
                        .append('<input class="form-control btn-secondary col-3" type="button" id="check-user"\n' +
                            ...
                            'value="แก้ไข">');
                    $("#submit").remove();
                    $("#submit_div").prepend('<button type="submit" id="submit" class="btn btn-danger btn-lg">ถอนเงิน</button>')
                },
                error: function () {
                    alert('ไม่พบผู้ใช้')
                }
